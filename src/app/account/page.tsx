            ...
            <div className='mt-[4vh] ml-[2vw]'>
                <div className='flex flex-col gap-2 profile-other-info'>
                    <span className="flex flex-row items-start">
                        ...
                        <p className="break-words flex-1 min-w-1/2">Университет телекоммуникаций</p>
                    </span>
                    <span className="flex flex-row items-start">
                        <h1 className="break-words flex-1 min-w-1/2">Факультет:</h1>
                        <p className="break-words flex-1 min-w-1/2">Информационных технологий и программной инженерии(ИТПИ)</p>
                    </span>
                    <span className="flex flex-row items-start">
                        <h1 className="break-words flex-1 min-w-[1/2">Специцальность/направление: </h1>
                        <p className="break-words flex-1 min-w-1/2">09.03.02 - Информационные системы и технологии</p>
                    </span>
                    <span className="flex flex-row items-start">
                        <h1 className="break-wordsflex-1 min-w-1/2">Форма обучения, квалификация: </h1>
                        <p className="break-words flex-1 min-w-1/2">Очная, Бакалавр</p>
                    </span>
                    <span className="flex flex-row items-start">
                        <h1 className="break-wordsflex-1 min-w-1/2">Профиль: </h1>
                        <p className="break-words flex-1 min-w-1/2">Системное и прикладное программирование информационных систем</p>
                    </span>
                    <span className="flex flex-row items-start">
                    ...
                    <span className="flex flex-row items-start">
                        <h1 className="break-wordsflex-1 min-w-1/2">Год начала обучения:</h1>
                        <p className="break-words flex-1 min-w-1/2">2024</p>
                    </span>
                    <span className="flex flex-row items-start">
                        <h1 className="break-wordsflex-1 min-w-1/2">Год окончания обучения:</h1>
